...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(SchemaLoader_getType_overloads,
                                       getType,
                                       1,
                                       1)
...
void defineResourceTypes(void) {
  ...
  AbstractType<kj::BufferedOutputStream,
               boost::python::bases<kj::OutputStream>>("BufferedOutputStream",
                                                       boost::python::no_init);

  ResourceType<kj::BufferedInputStreamWrapper,
               boost::python::bases<kj::BufferedInputStream>>(
      "BufferedInputStreamWrapper", boost::python::init<kj::InputStream&>());

  ResourceType<kj::BufferedOutputStreamWrapper,
               boost::python::bases<kj::BufferedOutputStream>>(
      "BufferedOutputStreamWrapper", boost::python::init<kj::OutputStream&>());

  ResourceType<kj::ArrayInputStream,
               boost::python::bases<kj::BufferedInputStream>>(
      "ArrayInputStream", boost::python::init<kj::ArrayPtr<const kj::byte>>());

  ResourceType<kj::VectorOutputStream,
               boost::python::bases<kj::BufferedOutputStream>>(
      "VectorOutputStream",
      boost::python::init<boost::python::optional<size_t>>())
  ...
  ValueType<capnp::ReaderOptions>("ReaderOptions")
      .def_readwrite("traversalLimitInWords",
                     &capnp::ReaderOptions::traversalLimitInWords)
      .def_readwrite("nestingLimit", &capnp::ReaderOptions::nestingLimit);

  boost::python::class_<capnp::MessageReader, boost::noncopyable>(
      "MessageReader", boost::python::no_init)
      .def("getRoot",
           &capnp::MessageReader::getRoot<capnp::schema::CodeGeneratorRequest>)
      .def("getRoot", &capnp::MessageReader::getRoot<capnp::DynamicStruct,
                                                     capnp::StructSchema>)
      .def("isCanonical", &capnp::MessageReader::isCanonical);

  boost::python::class_<capnp::MessageBuilder, boost::noncopyable>(
      "MessageBuilder", boost::python::no_init)
      // TODO: Boost doesn't seem to support rvalue reference
      //.def("setRoot", &capnp::MessageBuilder::setRoot<capnp::DynamicStruct::Reader>)
      .def("getRoot", &capnp::MessageBuilder::getRoot<capnp::DynamicStruct,
                                                      capnp::StructSchema>)
      .def("initRoot", &capnp::MessageBuilder::initRoot<capnp::DynamicStruct,
                                                        capnp::StructSchema>)
      .def("isCanonical", &capnp::MessageBuilder::isCanonical);

  ResourceType<capnp::MallocMessageBuilder,
               boost::python::bases<capnp::MessageBuilder>>
  ...
  ResourceType<capnp::SchemaLoader>
      ...
      ("SchemaLoader", boost::python::init<>())
          ...
          .def("getType", &capnp::SchemaLoader::getType,
               SchemaLoader_getType_overloads())
  ...
  ResourceType<capnp::FlatArrayMessageReader,
               boost::python::bases<capnp::MessageReader>>(
  ...
  ResourceType<capnp::InputStreamMessageReader,
               boost::python::bases<capnp::MessageReader>>(
      "InputStreamMessageReader",
      boost::python::init<kj::InputStream&,
                          boost::python::optional<capnp::ReaderOptions>>());

  ResourceType<capnp::StreamFdMessageReader,
               boost::python::bases<capnp::InputStreamMessageReader>>(
  ...
  DEF_FUNC(capnp, messageToFlatArray, kj::Array<capnp::word>,
           capnp::MessageBuilder&);

  DEF_FUNC(capnp, writeMessage, void, kj::OutputStream&,
           capnp::MessageBuilder&);
  ...
  ResourceType<capnp::PackedMessageReader,
               boost::python::bases<capnp::InputStreamMessageReader>>(
      "PackedMessageReader",
      boost::python::init<kj::BufferedInputStream&,
                          boost::python::optional<capnp::ReaderOptions>>());

  ResourceType<capnp::PackedFdMessageReader,
               boost::python::bases<capnp::PackedMessageReader>>(
      "PackedFdMessageReader",
      boost::python::init<int,
                          boost::python::optional<capnp::ReaderOptions>>());

  DEF_FUNC(capnp, writePackedMessage, void, kj::BufferedOutputStream&,
           capnp::MessageBuilder&);
  DEF_FUNC(capnp, writePackedMessageToFd, void, int, capnp::MessageBuilder&);

  boost::python::def("computeUnpackedSizeInWords",
                     capnp::computeUnpackedSizeInWords);
}
